...
class ViewController: UIViewController {
    ...
    @IBAction func buttonClicked(_ sender: Any) {
        var testTask = Task(label: "TestTask",completed: false,description: "This is a test task", taskImages: [UIImage(systemName: "photo")!,UIImage(systemName: "photo")!],dateDue: Date(), taskType: Task.TYPE.hobby)
